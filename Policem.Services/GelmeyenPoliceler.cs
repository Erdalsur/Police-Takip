...
{
    public class GelmeyenPoliceler : IJob
    {
        ...
        private void GelmeyenPolicelerim()
        {
            //GridAyarla();
            ...
            DosyayaKaydet();
            //Mail Gönderme yap
            if (form.gridViewPoliceler.RowCount> 0)
        ...
        private static void MailGonder(string mailAdresleri)
        {
            ...
            ePosta.Subject = "Gelmeyen Poliçeler";
            ePosta.IsBodyHtml = true;
            var icerik = File.ReadAllText(Session.TempDosyaYolu + "\\Gelmeyen Policeler.html"); ;
            ePosta.Body = icerik;
            ePosta.Attachments.Add(new Attachment(Session.TempDosyaYolu + "\\Gelmeyen Policeler.xlsx"));
        ...
        private void DosyayaKaydet()
        {
            ...
            printableComponentLink1.ExportToXlsx(Session.TempDosyaYolu + "\\Gelmeyen Policeler.xlsx");
            printableComponentLink1.ExportToHtml(Session.TempDosyaYolu + "\\Gelmeyen Policeler.html");
        }
