...
{
    public class GelecekAyBitecekPoliceler : IJob
    {
        public DateTime GelecekAyBasi;
        public DateTime GelecekAyBitis;
        ...
        private void RaporOlustur()
        {
            ...
            GelecekAyBasi = Core.Extensions.ExtensionMethods.AyinBaslangici(DateTime.Now).AddMonths(1);
            GelecekAyBitis = GelecekAyBasi.AddMonths(1).AddDays(-1);
            ...
            RaporPoliceleri = policelerim.Where(t => t.PoliceBitisTarih > GelecekAyBasi).
                Where(t => t.PoliceBitisTarih < GelecekAyBitis).ToList();
        ...
        private void DosyayaKaydet()
        {
            ...
            printableComponentLink1.ExportToXlsx(Session.TempDosyaYolu + "\\Gelecek Ay Bitecek Policeler.xlsx");
            printableComponentLink1.ExportToHtml(Session.TempDosyaYolu + "\\Gelecek Ay Bitecek Policeler.html");
        }
        ...
        {
            DateTime Ay = Core.Extensions.ExtensionMethods.AyinBaslangici(DateTime.Now).AddMonths(1);
            ...
            ePosta.Subject =Ay.ToString("MMMM")+"-"+Ay.ToString("yyyy")+" Dönemi Bitecek Poliçeler";
            ePosta.IsBodyHtml = true;
            var icerik = File.ReadAllText(Session.TempDosyaYolu + "\\Gelecek Ay Bitecek Policeler.html"); ;
            ePosta.Body = icerik;
            ePosta.Attachments.Add(new Attachment(Session.TempDosyaYolu + "\\Gelecek Ay Bitecek Policeler.xlsx"));
