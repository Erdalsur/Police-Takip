...
{
    public class Son7GunBitecekPoliceler : IJob
    {
        ...
        private void DosyayaKaydet()
        {
            ...
            printableComponentLink1.ExportToXlsx(Session.TempDosyaYolu + "\\7 Gun içinde Bitecek Policeler.xlsx");
            printableComponentLink1.ExportToHtml(Session.TempDosyaYolu + "\\7 Gun içinde Bitecek Policeler.html");
        }
        ...
        private static void MailGonder(string mailAdresleri)
        {
            ...
            var icerik = File.ReadAllText(Session.TempDosyaYolu + "\\7 Gun içinde Bitecek Policeler.html"); ;
            ePosta.Body = icerik;
            ePosta.Attachments.Add(new Attachment(Session.TempDosyaYolu + "\\7 Gun içinde Bitecek Policeler.xlsx"));
