...
namespace Policem.UI.Forms
{
    public partial class FrmAyarlar : XPopupForm
    {
        ...
        private void BtnKaydet_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            AppSession.PrgSettingsOrg.ZorunluAlanRengi = ((Color)this.colorPickEditZorunlu.EditValue).Name;
            AppSession.PrgSettingsOrg.AktifAlanRengi = ((Color)this.colorAktifEdit.EditValue).Name;
            AppSession.PrgSettingsOrg.SkinName = UserLookAndFeel.Default.SkinName;
            AppSession.PrgSettingsOrg.OutlookMailAdresi = txtMailAdresi.EditValue.ToString();
            AppSession.PrgSettingsOrg.MuayeneTakvimHatirlatici = Convert.ToInt32(txtMuyaneHatirlaticiSayisi.EditValue);
            AppSession.PrgSettingsOrg.Save();
