...
namespace Policem.UI.DependencyResolution
{
    ...
    {
        public Session(IPoliceService policeService, IPoliceMusteriService musteriService, ISigortaFirmaService sigortaService, IPoliceDosyaService policeDosyaService,IFirmaPoliceService firmaPoliceService)
        {
            try
            {
                ...
                FirmaPoliceService = firmaPoliceService;
            }
            catch
            {
                MessageBox.Show("Servisler Yükelenemedi.");
            }
            ...
            {
                MessageBox.Show("Ayar.ini Dosya Yüklenme Hatası! Ayar Bölümünde Kayıt Ediniz.");
            }
        }
        ...
        public static IFirmaPoliceService FirmaPoliceService;
