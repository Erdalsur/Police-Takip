...
namespace Policem.Core.Utility
{
    public class GridMenu
    {
        ...
        private void CopyToClipboardWithColumnHeaders_Click(object sender, EventArgs e) => GridView.OptionsBehavior.CopyToClipboardWithColumnHeaders = !GridView.OptionsBehavior.CopyToClipboardWithColumnHeaders;
    ...
    public class GridUtility
    {
        ...
        public string GetSelectionInfo()
        {
            ...
            foreach (GridCell selectedCell in this.GridView.GetSelectedCells())
            {
                ...
                {
                    double result = 0.0;
                    if (double.TryParse(rowCellDisplayText.ToString(), out result))
                        ++num3;
                    num1 += result;
                }
            }
